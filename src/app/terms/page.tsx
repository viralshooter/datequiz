...
export const metadata = { title: "Termini di servizio — DateQuiz" };
  ...
  return (
    <div className="min-h-dvh bg-white">
      ...
      <div className="mx-auto max-w-2xl px-6 py-10">
        ...
        <h1 className="text-2xl font-extrabold text-neutral-900">Termini di servizio</h1>
        ...
        <Section title="Il servizio">
          DateQuiz permette di creare un link personalizzato per invitare qualcuno
